...
import Html exposing (Html, div, h1,h2,h3,text, ul, li,p,a,canvas, progress,button)
...
aboutView model =
        ...
        div[     
            ...
            [
                ...
                div[style "margin-left" "20%",style "margin-right" "20%"][h2[style "color" "white"][text "Team: GEAR"]],
                div[style "margin-left" "20%",style "margin-right" "20%"][h2[style "color" "white"][text "Member:"]],
                div[style "margin-left" "20%",style "margin-right" "20%"][h3[style "color" "white"][text "1)    Zihao Wei"]],
                div[style "margin-left" "20%",style "margin-right" "20%"][h3[style "color" "white"][text "2)    Yidong Huang"]], 
                div[style "margin-left" "20%",style "margin-right" "20%"][h3[style "color" "white"][text "3)    Qifei Wu"]], 
                div[style "margin-left" "20%",style "margin-right" "20%"][h3[style "color" "white"][text "4)    Siyuan Lin"]],    
