...
monsterTypeList = 
    let
        m1=MonsterType 30 20 "#Robot1" 30
        m2=MonsterType 60 20 "#Robot1" 60
        m7=MonsterType 200 20 "#Robot1" 200
        m3=MonsterType 300 40 "#Robot2" 300
        m4=MonsterType 600 40 "#Robot2" 600
        m5=MonsterType 1000 60 "#Robot3" 1000
        m6=MonsterType 2000 60 "#Robot3" 2000
