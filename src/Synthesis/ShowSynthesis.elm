...
showSynthesis model =
    ...
    in
        if sys.active then
                ...
                , style "background-image" "url(images/InterfaceBg/b5.jpg)"
                , style "border-radius" "35px"
                , style "box-shadow" "20px 20px 10px #888888"
                , style "border-style" "inset"
                , style "opacity" "0.89"
                ]
                [    div [style "position" "absolute",style "margin-left" "200px",style "margin-top" "5px", style "color" "#99ccff",style "font-size" "25px",style "text-shadow" "5px 5px 5px black"] [text "Upgrade & Synthesis System"]
                    , div[][ button [class "btn btn-primary btn-ghost btn-shine", style "color" "black",style "margin-left" "40px",style "margin-top" "40px",style "width" "100px", style "height" "30px", style "background" "linear-gradient(to right, #99ccff, #009999)", onClick <| SynthesisSystem <| NextWeapon False] [text "<"]
                    , div [style "position" "absolute",style "margin-left" "230px",style "margin-top" "-25px",style "font-size" "18px",style "font-weight" "bold",style "color" "black"] [text ("Upgrade: "++getName)]
                    , div [style "position" "absolute",style "margin-left" "430px",style "margin-top" "-25px",style "font-size" "18px",style "font-weight" "bold",style "color" "black"] [text ("Level: "++String.fromInt weaponNow.level)]
                    ...
                    , button [class "btn btn-primary btn-ghost btn-shine", style "color" "black",style "margin-left" "40px",style "margin-top" "10px",style "width" "100px", style "height" "30px", style "background" "linear-gradient(to left, #99ccff, #009999)", onClick <| SynthesisSystem <| NextWeapon True] [text ">"]
                    ...
                    , button [ class "btn btn-primary btn-ghost btn-shine",style "color" "black",style "position" "absolute",style "margin-top" "-90px" , style "margin-left" "580px",style "width" "90px",style "height" "80px",style "background" "linear-gradient(to right, #99ccff, #009999)",onClick <| SynthesisSystem <| Synthesis] [text "Upgrade"]
                    ]
                    --Bullet
                    ...
                    , button [ class "btn btn-primary btn-ghost btn-shine",style "position" "absolute",style "margin-top" "-90px" , style "color" "black",style "margin-left" "580px",style "width" "90px",style "height" "80px", style "background" "linear-gradient(to right, #99ccff, #009999)", onClick <| SynthesisSystem <| SynthesisBullet] [text "Synthesis"]
                    ]
                    , div [style "margin-left" "200px",style "margin-top" "5px",style "position" "absolute",style "font-size" "20px",style "font-weight" "bold",style "color" "black"][text("Tip: "++sys.tip)]
                ]
        else
            div [] []