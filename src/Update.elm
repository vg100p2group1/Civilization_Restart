...
animate  model =
    ...
    let
        ...
        (newShoot, weapon,newaudio) = if model.myself.fire then
    ...
    in
        {model| myself = {meCooling|weapons=newWeapons,counter=newMe.counter+1,url=playerMove newMe,currentWeapon={weapon|counter=weaponCounter,period=newPeriod,shiftCounter=shiftCounter},addAudio=newaudio},
